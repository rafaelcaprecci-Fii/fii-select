  ...
  return {
    common: {
      ...
      sharesOutstanding: positiveNumber(
        firstDefined(data.patrimonial?.sharesOutstanding, data.report?.sharesOutstanding),
      ),
      totalInvestors: positiveNumber(
        firstDefined(data.patrimonial?.totalInvestors, data.report?.totalInvestors),
      ),
      adminFeeRate: nullableNumber(data.report?.adminFeeRate),
      cri: nullableNumber(data.report?.cri),
      lci: nullableNumber(data.report?.lci),
      fiiHoldings: nullableNumber(data.report?.fiiHoldings),
      cash: nullableNumber(firstDefined(data.report?.cash, data.portfolio?.summary?.cash)),
